...
# (col_index, x, y, height) from find_cards.py results
tableau_boxes = [
    (0, 10, 507, 471),
    (1, 111, 507, 423),
    (2, 212, 507, 519),
...
STEP = 50
RANK_OFFSET = (10, 6, 26, 24)   # x, y, w, h relative to card top-left
...
for col_idx, x, y_top, height in tableau_boxes:
    ...
    while y < y_top + height - 20:
        rx, ry, rw, rh = RANK_OFFSET
        rank_patch = img[y+ry:y+ry+rh, x+rx:x+rx+rw]

        suit_patch = img[y+ry+rh:y+ry+rh+20, x+rx:x+rx+rw]
